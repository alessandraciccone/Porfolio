...
const netflixImages = [
  {
    src: "/src/assets/img/Netflix/HomePage.png",
    desc: "Homepage con anteprime e suggerimenti personalizzati",
  },
  {
    src: "/src/assets/img/Netflix/Player.png",
    desc: "Schermata del player video con controlli avanzati",
  },
];
  ...
  return (
    <section id="netflix" className="py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-red-500 to-red-600 mb-8 drop-shadow-lg">
          Netflix Clone
        </h2>
        <div>
